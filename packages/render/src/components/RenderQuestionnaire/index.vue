 ...
 * @LastEditTime: 2024-04-20 11:21:00
-->
<template>
  <div class="questionnaire">
    <img
      class="questionnaire-banner"
    ...
    <div class="form">
      ...
      <div class="form-description space">
        {{ project?.description }}
      </div>
      ...
      <div class="form-sign">榫卯设计 提供支持</div>
    </div>
  </div>
</template>
...
const model = ref({});
// 物料列表
const widgetList = computed(() => props.project?.pageList[0]?.widgetList || []);
