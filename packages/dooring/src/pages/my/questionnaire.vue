 ...
 * @LastEditTime: 2024-10-23 16:26:49
-->
<template>
  <div class="pl-30 pr-30">
    <div class="mt-30 mb-20 text-18">我的问卷</div>
    <el-alert
      title="春来我不先开口，哪个虫儿敢作声"
    >
    </el-alert>
    <ProductForPage :getList="getList" type="questionnaire" operation="edit" :gap="30"/>
  </div>
</template>
