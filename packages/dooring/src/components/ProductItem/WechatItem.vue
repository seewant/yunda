 ...
 * @LastEditTime: 2024-10-28 16:21:29
-->
<template>
  <div class="cover" @click="handleEdit(item)">
    ...
    <div class="cover-operation">
      ...
      <div v-else class="absolute w-full h-full flex flex-col justify-center items-center p-5">
...
const path = `${Configuration.YUNDA_H5_PATH}pages/render/screenshot?type=wechat&id=${props.item.id}`;
